...
class TestChatModel(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_message1 = Message.objects.create(
            chat=cls.test_chat, author=cls.test_user1, content="message1"
        )
        cls.test_message2 = Message.objects.create(
            chat=cls.test_chat, author=cls.test_user1, content="message2"
        )
        cls.test_message3 = Message.objects.create(
            chat=cls.test_chat, author=cls.test_user2, content="message3"
        )
