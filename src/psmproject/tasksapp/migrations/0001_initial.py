# Generated by Django 4.2.8 on 2024-01-24 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("realization_time", models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "advance_percentage",
                    models.PositiveIntegerField(default=20, validators=[django.core.validators.MaxValueValidator(50)]),
                ),
                ("total_cost", models.DecimalField(decimal_places=2, max_digits=8)),
                ("amount_due_to_contractor", models.DecimalField(decimal_places=2, max_digits=8)),
                ("advance_amount", models.DecimalField(decimal_places=2, max_digits=8)),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                null=True, on_delete=django.db.models.deletion.CASCADE, related_name="offer", to="tasksapp.payment"
            ),
        ),
        migrations.AddField(
            model_name="offer",
